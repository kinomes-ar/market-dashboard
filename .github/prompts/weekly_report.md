...
수정 허용: <!--WKREPORT_KO-->·<!--WKREPORT_EN--> 사이(각 5개 <li>: 주간총평/미국/한국/중국/매크로테마+다음주 일정), 헤더 <b class="upd" data-mkt="weeklyreport"> data-iso, 푸터 버전 셋째자리 +1.
재료: WebSearch 각국 2~3회(주간 등락·정책·수급·환율). 등락 span.up/down. 마커 assert.
